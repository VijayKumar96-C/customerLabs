...
function DetailsCard({ setIshow }) {
    ...
    const handleSaveClick = () => {
        const finalData =  JSON.stringify({ segment_name: segName, schema: selectedSchema })
        // console.log(finalData)
        axios.post("https://webhook.site/cd0bc93c-3d6e-42d3-9741-b48f54094ee1",finalData).then((res)=>{console.log(res)})
